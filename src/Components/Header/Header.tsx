const Header = () => {
  return (
    <div className="main flex h-screen  flex-col bg-light-beige 
      sm:h-full sm:py-5 md:h-screen">
      <div className="navbar text-dark-brown font-normal font-k2d tracking-widest flex justify-center items-center text-center h-[10vh] 
          text-sm
          xs:text-base
          ...
          <div className=" text-content
            ...
            <div
              className="main-header-text text-dark-brown font-extrabold font-inter
                  ...
                  lg:text-[4.2rem] lg:max-w-[25.5rem] lg:leading-[4.4rem]
            ...
            <div className="cta-buttons flex flex-row gap-3 items-center justify-center
            xs:w-[60%]
            sm:w-full">
              <button
                type="button"
