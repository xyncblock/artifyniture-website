...
const ProductIntro = () => {
  ...
  return (
    <motion.section className="product-intro w-full h-screen  xs:h-full flex flex-col items-center justify-between 
      py-14 
      ...
      <div className="text-section h-2/3 xs:h-full flex flex-col items-center justify-center xs:px-[5%]  px-[5%]
        xs:pb-12 
        sm:pb-18">
        <motion.div className="text-dark-brown xs:font-normal font-inter text-center items-center 
        ...
        <motion.div className="text-center text-light-gray font-[350] font-inter px-[14%]
          text-base
        ...
        <motion.button className="bg-grayish-brown hover:bg-light-gray flex flex-row justify-center items-center 
